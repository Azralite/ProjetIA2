...
public class Point5 {
    ...
    public static void main(String[] args) {
        ...
        // On assigne aleatoirement nos centres entre -5 et 5, nos ecarts a 1 et ro a 1/K
        for (int i = 0; i < centre.length; i++){
            ro[i] = 1.0/K;
            for (int j= 0 ; j < centre[i].length; j++){
                centre[i][j] = rand.nextDouble();
                ecarts[i][j] = 1;
            }
        }


        // On lance notre boucle jusqu'a ce que les centre ne se deplacent plus
        ...
        TasGaussien.ecrHist(hist, "hist.d");
